...
// Subject Data
$subjectName = "Business Skills II";
$subjectCode = "BMT 2033";

// Drive Links Data
$lessons = [
    ['year' => '18/19', 'title' => 'Past Paper 01', 'link' => 'https://drive.google.com/file/d/1QUaP0zwmUwbOvzcGZIjvwNo-yKvhR9sI/view?usp=drive_link'],
    ['year' => '19/20', 'title' => 'Past Paper 02', 'link' => 'https://drive.google.com/file/d/14pSTmJtNeTk460d5TeQ4oT9oxXxkNacy/view?usp=drive_link'],
    ['year' => '21/22', 'title' => 'Past Paper 03', 'link' => 'https://drive.google.com/file/d/1zlRczs34-7K2mf5ZWPidvUTYCB1SGRv5/view?usp=drive_link'],
    ...
    <header class="bg-slate-900/60 backdrop-blur-xl border-b border-slate-800 sticky top-0 z-40">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="skill2.php" class="hover:text-indigo-400 transition-colors">

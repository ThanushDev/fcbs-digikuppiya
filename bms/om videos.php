...
// Video Data
$VIDEOS = [
    ['id' => 'VfqbApKlPzY', 'title' => '21/22 Past Paper Discussion', 'duration' => '01:58:16', 'level' => 'Beginner', 'views' => 'FCBS Digi Kuppiya'],
];
?>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                ...
                <h2 class="text-4xl font-black text-white tracking-tight">Operations Management</h2>
                <p class="text-slate-400 mt-2 font-medium">Course Code: BMT- 2053</p>
            </div>

...
// --- MICRO ECONOMICS VIDEO DATA ---
$VIDEOS = [
    ['id' => 'E4DiyegZWWw', 'title' => 'Micro Economics - Video 01', 'duration' => '02:26:24', 'views' => 'FCBS Digi Kuppiya'],
    ['id' => '9-Fhdm6Dt9U', 'title' => 'Consumer Behaviour', 'duration' => '01:08:27', 'views' => 'FCBS Digi Kuppiya'],
    ['id' => 'ptGuq5fVa0c', 'title' => 'Revision of 2026/01/18', 'duration' => '01:15:56', 'views' => 'FCBS Digi Kuppiya']
];
?>
...
<head>
    ...
    <title>FCBS Digi Kuppiya - Micro Economics</title>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                ...
                <h2 class="text-4xl font-black text-white tracking-tight">Micro Economics</h2>
                <p class="text-slate-400 mt-2 font-medium">Course Code: BMT- 1053</p>
            </div>

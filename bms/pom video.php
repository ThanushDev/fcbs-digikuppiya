...
$VIDEOS = [
    ['id' => 'gmqUpO6ffao', 'title' => 'Video 01', 'duration' => '02:28:58', 'views' => 'FCBS Digi Kuppiya'],
    ['id' => 'zhvMARY-L-k', 'title' => '21/22 Past Paper Discussion', 'duration' => '01:50:58', 'views' => 'FCBS Digi Kuppiya'],
    ['id' => 'TfCIBVyi-W4', 'title' => '22/23 Past Paper Discussion', 'duration' => '01:37:02', 'views' => 'FCBS Digi Kuppiya'],
    ['id' => '8VH17cRNyCk', 'title' => 'Evaluation', 'duration' => '31:22', 'views' => 'FCBS Digi Kuppiya']
];
?>
...
<head>
    ...
    <title>FCBS Digi Kuppiya - Principle of Management</title>
        ...
        <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                <nav class="flex text-xs font-bold text-indigo-400 uppercase tracking-widest mb-2 gap-2">
                    <span>Year I</span> <span class="text-slate-700">/</span> <span>Semester I</span>
                </nav>
                <h2 class="text-4xl font-black text-white tracking-tight">Principle of Management</h2>
                <p class="text-slate-400 mt-2 font-medium">Course Code: BMT- 1013</p>
            </div>

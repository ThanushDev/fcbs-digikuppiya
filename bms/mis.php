...
<body class="text-white" x-data="{ modalOpen: <?= (isset($_GET['success']) ? 'true' : 'false') ?>, activeTab: 'details', profileDropdown: false }">
    ...
    <main class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <?php
            renderResourceCard("Chapters", "07", "book-open", "blue", "mis chapters.php");
            renderResourceCard("Past Papers", "09", "history", "purple", "mis pp.php");
            renderResourceCard("Short Notes", "Soon", "clipboard-list", "emerald", "#");
            renderResourceCard("Kuppi Videos", "08", "play-circle", "orange", "mis video.php");
            ?>
        </div>
    </main>

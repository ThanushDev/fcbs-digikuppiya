...
$subjectCode = "BMT- 1063";

// Drive Links Data
$lessons = [
    ['year' => '01', 'title' => 'Collection and grouping numerical data', 'link' => 'https://docs.google.com/presentation/d/1CPqzHJSOqqTikA5Eornuagpf9lcdOX2K/edit?usp=drive_link&ouid=111426761158529297809&rtpof=true&sd=true'],
    ['year' => '02', 'title' => 'Correlation and regression analysis', 'link' => 'https://docs.google.com/presentation/d/1pccCeuucF3nSfI8-ubG0cvf3JeOl6Y6p/edit?usp=drive_link&ouid=111426761158529297809&rtpof=true&sd=true'],
    ['year' => '03', 'title' => 'Time Series analysis and Index Numbers', 'link' => 'https://docs.google.com/presentation/d/1zer1VZ82XjHKFttBug2trmYjcN6D5a-Q/edit?usp=drive_link&ouid=111426761158529297809&rtpof=true&sd=true'],
    ['year' => '04', 'title' => 'Probability and Probability Distributions', 'link' => 'https://docs.google.com/presentation/d/1vtN8YADW8UMkFLY1CmkSNYFf6Gdl2Ssv/edit?usp=drive_link&ouid=111426761158529297809&rtpof=true&sd=true'],
];
?>
    ...
    <header class="bg-slate-900/60 backdrop-blur-xl border-b border-slate-800 sticky top-0 z-40">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="statis.php" class="hover:text-indigo-400 transition-colors">

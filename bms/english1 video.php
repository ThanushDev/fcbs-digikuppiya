...
// Re-fetch user data for display from your database
$user = $_SESSION['user'];
...
// UPDATED VIDEO DATA (From your Business English Code)
$VIDEOS = [
    ['id' => 'EcpNfHI1Zvk', 'title' => 'Tenses Video', 'duration' => '28:25', 'views' => 'FCBS Digi Kuppiya'],
    ['id' => 'tH2GJEu4V0g', 'title' => 'Sentence Structure', 'duration' => '26:55', 'views' => 'FCBS Digi Kuppiya'],
    ['id' => 'R76LJuEQWnk', 'title' => 'Correlation Conjunctions', 'duration' => '15:00', 'views' => 'FCBS Digi Kuppiya']
];
?>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                ...
                <h2 class="text-4xl font-black text-white tracking-tight">Business English I</h2>
                <p class="text-slate-400 mt-2 font-medium">Course Code: BMT-1043</p>
            </div>
    ...
    <script>
        ...
        <?php if (isset($_GET['success']) || $error): ?>
            window.onload = function() {
                openModal();
                <?php if(isset($_GET['success']) && $_GET['success'] == 'pic_updated') echo "switchTab('tab-photo');"; ?>
            };
        <?php endif; ?>
    </script>
</body>

...
$subjects = [
    ['title' => 'Macro Economics', 'link' => 'macro.php', 'icon' => 'eye', 'color' => 'from-blue-500 to-cyan-400', 'bg' => 'bg-blue-500/10', 'border' => 'border-blue-500/20', 'text' => 'text-blue-400'],
    ['title' => 'Cost and Management Accounting', 'link' => 'cma.php', 'icon' => 'infinity', 'color' => 'from-emerald-500 to-teal-400', 'bg' => 'bg-emerald-500/10', 'border' => 'border-emerald-500/20', 'text' => 'text-emerald-400'],
    ['title' => 'Management Information System', 'link' => 'mis.php', 'icon' => 'database', 'color' => 'from-violet-500 to-purple-400', 'bg' => 'bg-violet-500/10', 'border' => 'border-violet-500/20', 'text' => 'text-violet-400'],
    ['title' => 'Business Skills I', 'link' => 'skill1.php', 'icon' => 'nut', 'color' => 'from-orange-500 to-yellow-400', 'bg' => 'bg-orange-500/10', 'border' => 'border-orange-500/20', 'text' => 'text-orange-400'],
    ['title' => 'Business Law', 'link' => 'law.php', 'icon' => 'shuffle', 'color' => 'from-rose-500 to-pink-400', 'bg' => 'bg-rose-500/10', 'border' => 'border-rose-500/20', 'text' => 'text-rose-400'],
    ['title' => 'Career Guidance', 'link' => 'career.php', 'icon' => 'star', 'color' => 'from-amber-500 to-orange-400', 'bg' => 'bg-amber-500/10', 'border' => 'border-amber-500/20', 'text' => 'text-orange-400']
];
?>
...
<head>
    ...
    <title>FCBS DIGI Kuppiya - Year II Semester I</title>
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
        <div>
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-white mb-6">
                ...
                <span class="font-medium text-xs uppercase tracking-widest">Year II Semester I</span>
            </div>

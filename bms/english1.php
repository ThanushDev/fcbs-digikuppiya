...
<head>
    ...
    <title>FCBS Digi Kuppiya - Business English I</title>
    ...
    <main class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div class="rounded-[2.5rem] bg-white/5 p-10 border border-white/10 relative overflow-hidden mb-12">
            ...
            <div class="relative z-10">
                ...
                <h1 class="text-4xl font-black text-white sm:text-6xl mb-2">Business English I</h1>
                <div class="flex items-center gap-3 mt-4">
                    <img src="assets/img/logo.png" alt="FCBS Logo" class="h-8 w-auto opacity-80">
                    <p class="text-white/60 text-lg">Year I Semester I • Academic Resource Portal</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <?php
            renderResourceCard("Chapters", "05", "book-open", "blue", "english1 chapters.php");
            renderResourceCard("Past Papers", "04", "file-text", "purple", "english1 pp.php");
            renderResourceCard("Short Notes", "Soon", "sticky-note", "emerald", "#");
            renderResourceCard("Kuppi Videos", "03", "video", "orange", "english1 video.php");
            ?>
        </div>
    </main>
        ...
        <div class="modal-content shadow-2xl">
            ...
            <div x-show="activeTab === 'details'">
                <form method="post" class="space-y-4">
                    ...
                    <button type="submit" name="updateDetails" class="w-full bg-gradient-to-r from-yellow-300 to-orange-400 text-slate-900 font-bold py-3.5 rounded-xl mt-2 shadow-lg hover:opacity-90 transition-opacity">Save Changes</button>
                </form>
            </div>
            
            <div x-show="activeTab === 'picture'" class="text-center">
                <div class="relative inline-block mb-6">
                    <img src="<?= $profilePicPath; ?>" class="w-28 h-28 rounded-3xl object-cover ring-4 ring-yellow-300/20 shadow-xl mx-auto">
                </div>
                <form method="post" enctype="multipart/form-data">
                    ...
                    <label for="file-upload" class="cursor-pointer inline-block bg-white/10 border border-white/10 px-8 py-3 rounded-xl text-sm font-bold mb-2 hover:bg-white/20 transition-colors">Choose New Photo</label>
                </form>
            </div>
        </div>
    </div>

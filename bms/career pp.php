...
$subjectCode = "BMT-2010";

// Drive Links Data
$lessons = [
    ['year' => '18/19', 'title' => 'Past Paper 01', 'link' => 'https://drive.google.com/file/d/14Md00KuS8pHtTpC5PaMyhcMydGvDOsIX/view?usp=sharing'],
    ['year' => '19/20', 'title' => 'Past Paper 02', 'link' => 'https://drive.google.com/file/d/1707QxslFuliXFBQ-NgkVY58VwVIWEpR9/view?usp=sharing'],
    ['year' => '20/21', 'title' => 'Past Paper 03', 'link' => 'https://drive.google.com/file/d/1Ubmhn-EZUDbl3feyTN6oK8TRv4f5VlEy/view?usp=sharing'],
    ['year' => '21/22', 'title' => 'Past Paper 04', 'link' => 'https://drive.google.com/file/d/1lBwfvtETVlg-HQ5yME5M-3Ojcrzs6HWT/view?usp=sharing']
];
?>
    ...
    <header class="bg-slate-900/60 backdrop-blur-xl border-b border-slate-800 sticky top-0 z-40">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="career.php" class="hover:text-indigo-400 transition-colors">

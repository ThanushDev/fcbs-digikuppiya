...
// Subject Data
$subjectName = "Business English II";
$subjectCode = "BMT- 1073";

// Drive Links Data
$lessons = [
    ['year' => '19/20', 'title' => 'Past Paper 01', 'link' => 'https://drive.google.com/file/d/1j9ZtQJXUgscGYh5CPlQWsn0ekR29-4pL/view?usp=drive_link'],
    ['year' => '20/21', 'title' => 'Past Paper 02', 'link' => 'https://drive.google.com/file/d/1odikP1vy72JXNGcjhlo6pb929sHJ1Dd9/view?usp=drive_link'],
    ['year' => '21/22', 'title' => 'Past Paper 03', 'link' => 'https://drive.google.com/file/d/1A8lBsXAvdRuZATn0cvrMD_05SMhdVFNu/view?usp=drive_link'],
    ['year' => '22/23', 'title' => 'Past Paper 04', 'link' => 'https://drive.google.com/file/d/1YUSwOq8U9I8QIOficNfZHSl2zeZg2n-W/view?usp=drive_link'],
    ...
    <header class="bg-slate-900/60 backdrop-blur-xl border-b border-slate-800 sticky top-0 z-40">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="english 2.php" class="hover:text-indigo-400 transition-colors">

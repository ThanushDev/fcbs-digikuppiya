<?php
// --- 1. MANDATORY PHP BACKEND LOGIC (Full Database Integration) ---
session_start();
include '../connect.php'; 
...
// ICT VIDEO DATA
$VIDEOS = [
    ['id' => 'arizBu3LWhA', 'title' => 'Introduction to the Computers', 'duration' => '39:00', 'views' => 'FCBS Digi Kuppiya'],
    ['id' => 'Dv0_M_ost6Y', 'title' => 'Input Output Devices', 'duration' => '30:06', 'views' => 'FCBS Digi Kuppiya'],
    ['id' => 'vPY_9JEyARU', 'title' => 'Network & Connectivity', 'duration' => '23:40', 'views' => 'FCBS Digi Kuppiya'],
    ['id' => 'zIyT9J2pAIg', 'title' => 'The System Unit', 'duration' => '32:26', 'views' => 'FCBS Digi Kuppiya'],
    ['id' => '2jCkIpA2KcI', 'title' => 'Application Software', 'duration' => '14:30', 'views' => 'FCBS Digi Kuppiya'],
    ['id' => 'vMCWB_bhXRo', 'title' => 'Storage Devices', 'duration' => '28:37', 'views' => 'FCBS Digi Kuppiya'],
    ['id' => 'vDLiixzOImY', 'title' => 'Software Engineering Basics', 'duration' => '18:42', 'views' => 'FCBS Digi Kuppiya'],
    ['id' => 'ov7VY18glhA', 'title' => 'Number Systems', 'duration' => '02:09:56', 'views' => 'FCBS Digi Kuppiya']
];
?>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                ...
                <h2 class="text-4xl font-black text-white tracking-tight">Information Technology</h2>
                <p class="text-slate-400 mt-2 font-medium">Course Code: BMT-1023</p>
            </div>

...
// Video Data
$VIDEOS = [
    ['id' => 'u8v7gnYb02U', 'title' => 'Capital Budget', 'duration' => '01:21:35', 'level' => 'Beginner', 'views' => 'FCBS Digi Kuppiya'],
    ['id' => 'xbjrtMqu74s', 'title' => 'Time Value', 'duration' => '01:37:58', 'level' => 'Beginner', 'views' => 'FCBS Digi Kuppiya']
];
?>
...
<head>
    ...
    <title>FCBS Digi Kuppiya - FM</title>
        ...
        <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                <nav class="flex text-xs font-bold text-indigo-400 uppercase tracking-widest mb-2 gap-2">
                    <span>Year II</span> <span class="text-slate-700">/</span> <span>Semester II</span>
                </nav>
                <h2 class="text-4xl font-black text-white tracking-tight">Financial Management</h2>
                <p class="text-slate-400 mt-2 font-medium">Course Code: AFM- 2023</p>
            </div>

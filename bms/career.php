...
session_start();
// Connection to database (one directory up)
include '../connect.php'; 
...
/**
 * ResourceCard function for Career Guidance
 */
...
<head>
    ...
    <title>FCBS Digi Kuppiya - Career Guidance</title>
...
<body class="text-white" x-data="{ modalOpen: false, activeTab: 'details', profileDropdown: false }">
    ...
    <main class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div class="rounded-[2.5rem] bg-white/5 p-10 border border-white/10 relative overflow-hidden mb-12">
            <div class="absolute top-0 right-0 -mt-8 -mr-8 h-64 w-64 rounded-full bg-emerald-500/10 blur-3xl"></div>
            <div class="relative z-10">
                ...
                <h1 class="text-4xl font-black text-white sm:text-6xl mb-2">Career Guidance</h1>
        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <?php
            renderResourceCard("Lecture Notes", "Soon", "book-open", "blue", "");
            renderResourceCard("Past Papers", "04", "file-text", "purple", "career pp.php");
            renderResourceCard("Short Notes", "Soon", "sticky-note", "emerald", "");
            renderResourceCard("Kuppi Video", "Soon", "video", "orange", "");
            ?>
        </div>
    </main>
        ...
        <div class="modal-content shadow-2xl">
            ...
            <div x-show="activeTab === 'picture'" class="text-center">
                <div class="relative inline-block mb-6">
                    ...
                    <div class="absolute -bottom-2 -right-2 bg-yellow-300 text-slate-900 p-2 rounded-lg shadow-lg">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <p class="text-[10px] text-gray-500 uppercase tracking-widest">Max size 3MB (JPG, PNG)</p>
                </form>
            </div>
        </div>
    </div>

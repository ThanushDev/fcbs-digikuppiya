...
/**
 * ResourceCard function for Business Mathematics
 */
...
<head>
    ...
    <title>Business Mathematics - Digi Kuppiya</title>
    ...
    <main class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div class="rounded-[2.5rem] bg-white/5 p-10 border border-white/10 relative overflow-hidden mb-12">
            ...
            <div class="relative z-10">
                ...
                <h1 class="text-4xl font-black text-white sm:text-6xl mb-2">Business Mathematics</h1>
        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <?php
            renderResourceCard("Chapters", "06", "book-open", "blue", "math chapters.php");
            renderResourceCard("Past Papers", "03", "history", "purple", "math pp.php");
            renderResourceCard("Short Notes", "01", "clipboard-list", "emerald", "math short.php");
            renderResourceCard("Kuppi Videos", "07", "play-circle", "orange", "math video.php");
            ?>
        </div>
    </main>

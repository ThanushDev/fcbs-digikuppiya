...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_GET['action']) && $_GET['action'] === 'chat') {
    ...
    // Custom system prompt for Semester 2 context
    $systemPrompt = "You are a helpful academic assistant for FCBS Digi Kuppiya Year 1 Semester 2. Help students with subjects like Accounting, HRM, Marketing, and Statistics. Answer in $lang language.";
...
$subjects = [
    ['title' => 'Financial Accounting', 'link' => 'facc.php', 'icon' => 'briefcase', 'color' => 'from-blue-500 to-cyan-400', 'bg' => 'bg-blue-500/10', 'border' => 'border-blue-500/20', 'text' => 'text-blue-400'],
    ['title' => 'Human Resource Management', 'link' => 'hrm.php', 'icon' => 'calculator', 'color' => 'from-emerald-500 to-teal-400', 'bg' => 'bg-emerald-500/10', 'border' => 'border-emerald-500/20', 'text' => 'text-emerald-400'],
    ['title' => 'Marketing Management', 'link' => 'mkt.php', 'icon' => 'cpu', 'color' => 'from-violet-500 to-purple-400', 'bg' => 'bg-violet-500/10', 'border' => 'border-violet-500/20', 'text' => 'text-violet-400'],
    ['title' => 'Business Statistics', 'link' => 'statis.php', 'icon' => 'trending-up', 'color' => 'from-orange-500 to-yellow-400', 'bg' => 'bg-orange-500/10', 'border' => 'border-orange-500/20', 'text' => 'text-orange-400'],
    ['title' => 'Basic English II', 'link' => 'english 2.php', 'icon' => 'languages', 'color' => 'from-rose-500 to-pink-400', 'bg' => 'bg-rose-500/10', 'border' => 'border-rose-500/20', 'text' => 'text-rose-400'],
    ['title' => 'Basic Tamil II / Sinhala II', 'link' => 'tasa1.php', 'icon' => 'pen-tool', 'color' => 'from-amber-500 to-orange-400', 'bg' => 'bg-amber-500/10', 'border' => 'border-amber-500/20', 'text' => 'text-amber-400']
];
?>
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
        <div>
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-white mb-6">
                ...
                <span class="font-medium text-xs uppercase tracking-widest">Year I Semester II</span>
            </div>
            <h1 class="text-5xl md:text-7xl font-bold text-white tracking-tight leading-tight">
                FCBS Digi Kuppiya <br />
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-pink-300">1.2 Starts Here</span>
            </h1>
        </div>
...
<script>
    ...
    async function sendChat() {
        ...
        try {
            ...
            appendMessage("Error connecting to AI. Please check your connection.", false);
        }
    }

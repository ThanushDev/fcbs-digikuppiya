...
<body class="text-white" x-data="{ modalOpen: false, activeTab: 'details', profileDropdown: false }">
    ...
    <main class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <?php
            renderResourceCard("Lecture Notes", "06", "book-open", "blue", "facc chapters.php");
            renderResourceCard("Past Papers", "05", "file-text", "purple", "facc pp.php");
            renderResourceCard("Short Notes", "01", "sticky-note", "emerald", "facc short.php");
            renderResourceCard("Kuppi Video", "01", "video", "orange", "facc videos.php");
            ?>
        </div>
    </main>

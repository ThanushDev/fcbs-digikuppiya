...
// Subject Data
$subjectName = "Peace and Social Harmony";
$subjectCode = "BMT- 2091";

// Drive Links Data
$lessons = [
    ['year' => '01', 'title' => 'Introduction to the Concepts of Peace & Conflict', 'link' => 'https://drive.google.com/file/d/1lF1_3J-uTNt7mhDfHx_OfL96TAvgtwoF/view?usp=drive_link'],
    ['year' => '02', 'title' => 'Conflict Resolution & Pease Building', 'link' => 'https://drive.google.com/file/d/1k4DoPJvlBlwlx90jVVt9MwctFPXwieOL/view?usp=drive_link'],
    ['year' => '04/05/06', 'title' => 'Conflict Resolution & Pease Building', 'link' => 'https://drive.google.com/file/d/1Vmau43aFlIpxIfxdqygXaEmUVQlKro8P/view?usp=drive_link'],
    ...
    <header class="bg-slate-900/60 backdrop-blur-xl border-b border-slate-800 sticky top-0 z-40">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="peace.php" class="hover:text-indigo-400 transition-colors">

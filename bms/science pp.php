...
$subjectCode = "NCC 2020";

// Drive Links Data
$lessons = [
    ['year' => '18/19', 'title' => 'Past Paper 01', 'link' => 'https://drive.google.com/file/d/1XkC-wu14BPu377QwOcMFKjz607Y7tzRq/view?usp=drive_link'],
    ['year' => '19/20', 'title' => 'Past Paper 02', 'link' => 'https://drive.google.com/file/d/1vWyLlX_qNe5tDXQA5CbtqdS0m8LCXQsj/view?usp=drive_link'],
    ['year' => '20/21', 'title' => 'Past Paper 03', 'link' => 'https://drive.google.com/file/d/1MfJSOE5QbjLi4g48IB5X-qnX4xKR5VTB/view?usp=drive_link'],
    ['year' => '21/22', 'title' => 'Past Paper 04', 'link' => 'https://drive.google.com/file/d/1M_BU8toYZDOFiuCuvI4OEMe-GtN3XYPr/view?usp=drive_link'],
    ...
    <header class="bg-slate-900/60 backdrop-blur-xl border-b border-slate-800 sticky top-0 z-40">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="science.php" class="hover:text-indigo-400 transition-colors">

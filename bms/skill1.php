...
/**
 * ResourceCard function for Business Skills I
 */
...
<head>
    ...
    <title>Business Skills I - Digi Kuppiya</title>
    ...
    <main class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div class="rounded-[2.5rem] bg-white/5 p-10 border border-white/10 relative overflow-hidden mb-12">
            ...
            <div class="relative z-10">
                ...
                <h1 class="text-4xl font-black text-white sm:text-6xl mb-2">Business Skills I</h1>
        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <?php
            renderResourceCard("Chapters", "Soon", "book-open", "blue", "#");
            renderResourceCard("Past Papers", "05", "history", "purple", "skill1 pp.php");
            renderResourceCard("Short Notes", "Soon", "clipboard-list", "emerald", "#");
            renderResourceCard("Kuppi Videos", "Soon", "play-circle", "orange", "#");
            ?>
        </div>
    </main>

...
// Video Data
$VIDEOS = [
    ['id' => '1Lr5OMvH9K0', 'title' => '22/23 Past Paper Discussion', 'duration' => '51:23', 'level' => 'Beginner', 'views' => 'FCBS Digi Kuppiya']
];
?>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                ...
                <h2 class="text-4xl font-black text-white tracking-tight">Financial Accounting</h2>
                <p class="text-slate-400 mt-2 font-medium">Course Code: AFM- 1013</p>
            </div>

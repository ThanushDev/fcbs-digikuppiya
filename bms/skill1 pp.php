...
// Subject Data
$subjectName = "Business Skills I";
$subjectCode = "BMT- 2033";

// Drive Links Data
$lessons = [
    ['year' => '18/19', 'title' => 'Past Paper 01', 'link' => 'https://drive.google.com/file/d/1uK_Vyqx0t0h64t-kDMpQgEnOj-ImKPkA/view?usp=sharing'],
    ['year' => '19/20', 'title' => 'Past Paper 02', 'link' => 'https://drive.google.com/file/d/1wzBB1s06n5CvPhM9u2hot74CxTzutTHS/view?usp=sharing'],
    ['year' => '20/21', 'title' => 'Past Paper 03', 'link' => 'https://drive.google.com/file/d/14dpQdEzLujbdAmzrxnwqJmu4NodqdQin/view?usp=sharing'],
    ['year' => '20/21 Repeat', 'title' => 'Past Paper 04', 'link' => 'https://drive.google.com/file/d/1a6nhA5oBcmywyV2iGJsVfC5MbjzdGXIK/view?usp=sharing'],
    ['year' => '21/22', 'title' => 'Past Paper 05', 'link' => 'https://drive.google.com/file/d/1UqoEd5W5yZFG9dlbLjhB0A5CxKn_qwyv/view?usp=sharing'],
    ...
    <header class="bg-slate-900/60 backdrop-blur-xl border-b border-slate-800 sticky top-0 z-40">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="skill1.php" class="hover:text-indigo-400 transition-colors">

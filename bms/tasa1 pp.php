...
// Subject Data
$subjectName = "Basic Tamil I / Sinhala I";
$subjectCode = "NCC- 1010 / 1020";

// Drive Links Data
$lessons = [
    ['year' => '19/20', 'title' => 'Tamil 01', 'link' => 'https://drive.google.com/file/d/1s1Fb5qx7sKodaxnzrguSkl_M_kbXbQMu/view?usp=drive_link'],
    ['year' => '19/20', 'title' => 'Sinhala 01', 'link' => 'https://drive.google.com/file/d/1uOzqo69cyTJavhhJr0eN7vIfilgU4wsg/view?usp=drive_link'],
    ['year' => '20/21', 'title' => 'Tamil 02', 'link' => 'https://drive.google.com/file/d/1zBkJ1wqxegvIHf2RhiiEbO-mvfndVw2v/view?usp=drive_link'],
    ['year' => '20/21', 'title' => 'Sinhala 02', 'link' => 'https://drive.google.com/file/d/16_Xgr7Tzw8XaMlrNijnngI-zUFyhKFGf/view?usp=drive_link'],
    ['year' => '22/23', 'title' => 'Sinhala 04', 'link' => 'https://drive.google.com/file/d/1_UOVn1Vbrg6dHYHTZ-Yw4a-2ljChrUkv/view?usp=drive_link'],
    ...
    <header class="bg-slate-900/60 backdrop-blur-xl border-b border-slate-800 sticky top-0 z-40">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="tasa1.php" class="hover:text-indigo-400 transition-colors">

...
// Subject Data
$subjectName = "Fundamental Sociology and Psychology";
$subjectCode = "BMT 2083";

// Drive Links Data
$lessons = [
    ['year' => '18/19', 'title' => 'Past Paper 01', 'link' => 'https://drive.google.com/file/d/1ssAg-ZUf0Pp3M6pmwEiCwCGbsFHH80QR/view?usp=drive_link'],
    ['year' => '19/20', 'title' => 'Past Paper 02', 'link' => 'https://drive.google.com/file/d/1FIHGZn1yqELf49PorCq771FnHASc5tsT/view?usp=drive_link'],
    ['year' => '20/21', 'title' => 'Past Paper 03', 'link' => 'https://drive.google.com/file/d/1itPkUr7flYhyaZm0fM8nHJefcE_PBLRZ/view?usp=drive_link'],
    ['year' => '21/22', 'title' => 'Past Paper 04', 'link' => 'https://drive.google.com/file/d/1hw_LHyzz_txE6t5iXqWOhXgdXi6NyeE1/view?usp=drive_link'],
    ...
    <header class="bg-slate-900/60 backdrop-blur-xl border-b border-slate-800 sticky top-0 z-40">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="funda.php" class="hover:text-indigo-400 transition-colors">

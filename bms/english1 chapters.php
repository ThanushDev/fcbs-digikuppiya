...
// Subject Data
$subjectName = "Business English I";
$subjectCode = "BMT- 1043";

// Drive Links Data
$lessons = [
    ['year' => '04-1', 'title' => 'Listen & Speaking', 'link' => 'https://drive.google.com/file/d/1KSleu4EK7AxoySDgwE9744agEa7iIUCV/view?usp=sharing'],
    ['year' => '04-2', 'title' => 'Grammer & E-Materials', 'link' => 'https://drive.google.com/file/d/1CgmFzw3D0IWoT4MueDo_ai8E8RFkk95P/view?usp=sharing'],
    ['year' => '08', 'title' => 'Writing', 'link' => 'https://docs.google.com/presentation/d/1y927vLg28K05a-KGELqOWoNO-WXcMHKB/edit?usp=sharing&ouid=111426761158529297809&rtpof=true&sd=true'],
    ['year' => '09', 'title' => 'Listening', 'link' => 'https://docs.google.com/presentation/d/1KIqi64y7k7LY-UXktYxs7hmKNMiRv1KC/edit?usp=sharing&ouid=111426761158529297809&rtpof=true&sd=true'],
    ['year' => '10', 'title' => 'Speaking', 'link' => 'https://drive.google.com/file/d/1mK0gP7eVn2sA1raCuJeyhLAlB3E4guTy/view?usp=sharing']
];
?>
    ...
    <header class="bg-slate-900/60 backdrop-blur-xl border-b border-slate-800 sticky top-0 z-40">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="english1.php" class="hover:text-indigo-400 transition-colors">

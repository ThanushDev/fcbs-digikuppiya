...
<head>
    ...
    <title>FCBS Digi Kuppiya - Business Law</title>
    ...
    <header class="sticky top-0 z-40 w-full border-b border-white/10 bg-white/5 backdrop-blur-md">
        <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative">
                ...
                <div x-show="profileDropdown" @click.away="profileDropdown = false" class="absolute right-0 mt-3 w-56 bg-slate-900 rounded-2xl shadow-2xl py-2 border border-white/10 overflow-hidden">
    ...
    <main class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div class="rounded-[2.5rem] bg-white/5 p-10 border border-white/10 relative overflow-hidden mb-12">
            ...
            <div class="relative z-10">
                ...
                <h1 class="text-4xl font-black text-white sm:text-6xl mb-2">Business Law</h1>
                <div class="flex items-center gap-3 mt-4">
                    <img src="assets/img/logo.png" alt="FCBS Logo" class="h-8 w-auto opacity-80">
                    <p class="text-white/60 text-lg">Year II Semester I • Academic Resource Portal</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <?php
            // Updated links for Business Law
            renderResourceCard("Chapters", "Soon", "gavel", "blue", "law chapters.php");
            renderResourceCard("Past Papers", "11", "history", "purple", "law pp.php");
            renderResourceCard("Short Notes", "Soon", "clipboard-list", "emerald", "law notes.php");
            renderResourceCard("Kuppi Videos", "Soon", "play-circle", "orange", "law video.php");
            ?>
        </div>
    </main>
    ...
    <div class="modal" :style="modalOpen ? 'display:block' : 'display:none'">
        <div class="modal-content shadow-2xl">
            ...
            <?php if (isset($_GET['success'])): ?>
                <div class="mb-4 p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-bold text-center">
                    Update Successful! ✨
                </div>
            <?php endif; ?>
            ...
            <div x-show="activeTab === 'details'">
                <form method="post" class="space-y-4">
                    ...
                    <button type="submit" name="updateDetails" class="w-full bg-gradient-to-r from-yellow-300 to-orange-400 text-slate-900 font-bold py-3.5 rounded-xl mt-2">Update Information</button>
                </form>
            </div>
            
            <div x-show="activeTab === 'picture'" class="text-center">
                <div class="mb-6 relative inline-block">
                    <img src="<?= $profilePicPath; ?>" class="w-24 h-24 rounded-2xl object-cover ring-2 ring-yellow-300/20 mx-auto">
                </div>
